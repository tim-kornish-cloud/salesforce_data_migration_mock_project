...
# success file path
success_file = dir_path + "\\Output\\UPDATE\\SUCCESS_Update_2_" + environment + "_" + object + "_" + database + ".csv"
# fallout file path
fallout_file = dir_path + "\\Output\\UPDATE\\FALLOUT_Update_2_" + environment + "_" + object + "_" + database + ".csv"
...
# query salesforce and return the contracts to be updated
...
sf_contracts_df['Status'] = "Activated"
...
passing_df, fallout_df = SF_Utils.upload_dataframe_to_salesforce(sf, sf_contracts_df, object, 'update', success_file, fallout_file, batch_size = 10)
...
success_table_name = "[dbo].[trgt_109_Contract_update_Success]"
# mssql table name the dataframe is being updated into
fallout_table_name = "[dbo].[trgt_109_Contract_update_Fallout]"

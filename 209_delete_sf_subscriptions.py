...
sf_subscriptions_df = Utils.encode_df(sf_subscriptions_df)

# delete migrated salesforce subscription records
# upload the records to salesforce for deletion
passing_df, fallout_df = SF_Utils.upload_dataframe_to_salesforce(sf, sf_subscriptions_df, 'SBQQ__Subscription__c', 'delete', success_file, fallout_file)
...
success_table_name = "[dbo].[trgt_del_209_subscriptions_Success]"
# mssql table name the dataframe is being inserted into
fallout_table_name = "[dbo].[trgt_del_209_subscriptions_Fallout]"

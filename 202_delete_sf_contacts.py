...
passing_df, fallout_df = SF_Utils.upload_dataframe_to_salesforce(sf, sf_contacts_df, object, 'delete', success_file, fallout_file)
...
success_table_name = "[dbo].[trgt_del_202_Contact_Success]"
# mssql table name the dataframe is being inserted into
fallout_table_name = "[dbo].[trgt_del_202_Contact_Fallout]"

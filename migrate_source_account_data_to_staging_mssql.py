...
Description: log into a MySQL Database.
             ...
             log into MSSQL staging database and insert records into accounts staging table
"""
...
accounts_query = "SELECT * FROM data_engineering.accounts"
...
column_types = ('str', 'str', 'str', 'float', 'str', 'int', 'int', 'str', 'int')

# mssql table name the dataframe is being inserted into
table_name = 'STG_SOURCE_Accounts'
